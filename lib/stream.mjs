...
// Prototypes
// ListOfStreamersClass.prototype.CHARACTERS            = (JSON.parse(loadCHARACTERS())).characters;
...
streamClass.prototype.createStreamer        = function () {
                                                ...
                                                /* if (this.CHARACTERSarr === []) { // || CHARACTERS === null) {
                                                    this.CHARACTERSarr =  loadCHARACTERS();
                                                } */
...
/* 
streamClass.prototype.init                  = function () {
                                                let obj = JSON.parse(loadCHARACTERS());
