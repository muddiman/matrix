...
export var ListOfStreamersClass = function () {
    ...
    this.init    = function () {
                    let i;                       
                    for (i=0; i < Math.floor( window.innerWidth/10 ); i++) {
                        this.list[i].init(i);
                    }
                 };
};
...
// Prototypes
ListOfStreamersClass.prototype.getList               = function () {                                        // List of streams
                                            return this.list;
                                        };
...
// Prototypes
streamClass.prototype.getStream = function () {                                                             //  stream of characters
                        return this.stream;
                    };
streamClass.prototype.CHARACTERS = CHARACTERS;
/* streamClass.prototype.setCHARACTERS = function () {
    const assetManager = new AssetManager();
    // assetManager.requestJSON("/lib/characters.JSON", (json)=>{console.log(json);});
        assetManager.getJSON("/lib/characters.JSON",  (json) => {
        //   console.log(json.characters);
